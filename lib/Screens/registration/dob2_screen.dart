...
import 'package:flutter_postpe_demo/Screens/registration/pancard_business.dart';
...
class DOB2Screen extends StatefulWidget {
  const DOB2Screen({Key? key}) : super(key: key);

  @override
  State<DOB2Screen> createState() => _DOB2ScreenState();
}

class _DOB2ScreenState extends State<DOB2Screen> {
  @override
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextLabel(labelText: "Established Year"),
              SizedBox(
                height: height / 100,
              ),
              Padding(
              ...
              TextLabel(labelText: "Select Industry Type"),
              SizedBox(
                height: height / 100,
              ),
              Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PancardBusiness(),
                        ));
                  },
                  child: Container(
                      width: 200,
