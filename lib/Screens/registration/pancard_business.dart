...
import 'package:flutter_postpe_demo/Screens/registration/adharcard_business.dart';
...
class PancardBusiness extends StatefulWidget {
  const PancardBusiness({Key? key}) : super(key: key);

  @override
  State<PancardBusiness> createState() => _PancardBusinessState();
}

class _PancardBusinessState extends State<PancardBusiness> {
  @override
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AdharcardBusiness(),
                        ));
                  },
                  child: Container(
                      width: 200,
