...
import 'package:flutter_postpe_demo/Screens/registration/company_name.dart';
...
class AdharcardScreen extends StatefulWidget {
  const AdharcardScreen({Key? key}) : super(key: key);

  @override
  State<AdharcardScreen> createState() => _AdharcardScreenState();
}

class _AdharcardScreenState extends State<AdharcardScreen> {
  @override
