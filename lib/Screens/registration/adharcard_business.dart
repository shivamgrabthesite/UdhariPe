...
class AdharcardBusiness extends StatefulWidget {
  const AdharcardBusiness({Key? key}) : super(key: key);

  @override
  State<AdharcardBusiness> createState() => _AdharcardBusinessState();
}

class _AdharcardBusinessState extends State<AdharcardBusiness> {
  @override
            ...
            children: [
              ...
              Padding(
                ...
                child: RichText(
                  ...
                  TextSpan(
                      text: "ADHAR NUMBER OF YOUR BUSINESS",
                      style: GoogleFonts.montserrat(
